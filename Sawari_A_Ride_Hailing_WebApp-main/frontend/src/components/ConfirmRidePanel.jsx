// filepath: c:\Users\Asus\Desktop\Git-Hub Projects\Uber-Clone\frontend\src\components\ConfirmRidePanel.jsx
  ...
  return (
    <div>
      ...
      <div className="flex gap-4 mt-1 justify-between items-center flex-col">
        <img className="h-20" src={imageUrl} alt={props.vehicleType} />
